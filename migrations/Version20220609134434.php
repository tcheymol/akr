 ...
 */
final class Version20220609134434 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE spot (id INT NOT NULL, name VARCHAR(255) NOT NULL, position VARCHAR(1000) DEFAULT NULL, access VARCHAR(1000) DEFAULT NULL, description TEXT DEFAULT NULL, orientation VARCHAR(1000) DEFAULT NULL, water VARCHAR(1000) DEFAULT NULL, dangers VARCHAR(1000) DEFAULT NULL, more TEXT DEFAULT NULL, security VARCHAR(1000) DEFAULT NULL, subtitle VARCHAR(1000) DEFAULT NULL, PRIMARY KEY(id))');
